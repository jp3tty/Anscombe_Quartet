# The Anscombe Quartet written in Python
# demonstartion data from
# Anscombe, F. J. 1973, Feb. Graphs in statistical analysis.
...
plt.savefig('Anscombe_Quartet/Results/fig_anscombe_Python.pdf', bbox_inches = 'tight', dpi=None,
